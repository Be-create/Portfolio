...
export const Projects = () => {
    ...
    return (
        ...
        <div style={{ marginTop: "200px", width: "100%" }}>
                ...
                <Flex direction={matches ? 'row' : 'column'}>
                    ...
                    <Box w={matches ? '35%' : '90%'} m="auto" h="300px">
                        ...
                        <Flex justifyContent="space-evenly" >
                            ...
                            <Button style={{ backgroundColor: isDark ? "#52057B" : "#FFE6F7" }} onClick={() => {
                                window.open("https://new-spotify-clone.netlify.app/")
                            }}>Github</Button>
                        </Flex>
                    </Box>
                ...
                <Flex direction={matches ? 'row' : 'column'}>
                    ...
                    <Box w={matches ? '60%' : '90%'} p={matches ? '0' : '10'}  >
                        ...
                        <ul>
                            <Listitem>Signup</Listitem>
                            <Listitem>Login</Listitem>
                            <Listitem>Add weekly tasks to weely calender </Listitem>
                            <Listitem>Manage Projects by add them to calender </Listitem>
                            <Listitem>Color code projects according to preference</Listitem>
                            <Listitem>Edits projects</Listitem>
                            <Listitem>Database to save all projects of user</Listitem>

                        </ul>
                        <Header style={{ color: isDark ? "#52057B" : "#FFE6F7" }}>Resposibilties</Header>
                        <ul>
                            <Listitem>Creating Signup page using React and chakra-ui</Listitem>
                            <Listitem>Creating Login page using React and chakra-ui</Listitem>
                            <Listitem>Creating Homepage page using React and chakra-ui</Listitem>
                            <Listitem>Creating sidebar for entire website</Listitem>
                            <Listitem>Creating feature to colorcode projects</Listitem>
                            <Listitem>Creating feature to getall projects by date and show them accordingly</Listitem>
            ...
            <Div> <Heading margin="auto" w="fit-content" mb="20" style={{ color: isDark ? "#52057B" : "#FFE6F7" }}>Recipe App</Heading>
                ...
                <Flex direction={matches ? 'row' : 'column'}>
                    ...
                    <Box w={matches ? '60%' : '90%'} p={matches ? '0' : '10'}  >
                        <Header style={{ color: isDark ? "#52057B" : "#FFE6F7" }}>Here you can get recipes for many delicious dishes</Header>
                        <Header style={{ color: isDark ? "#52057B" : "#FFE6F7" }}>Features</Header>
                        <ul>
                            <Listitem>Signup</Listitem>
                            <Listitem>Login</Listitem>

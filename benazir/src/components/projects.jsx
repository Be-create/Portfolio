...
export const Projects = () => {
    ...
    return (
        ...
        <div style={{ marginTop: "200px", width: "100%" ,color : isDark?  "orchid" : "darkorchid" }}>
...
>
           ...
           <motion.div style={{width:matches ? "80%" : "100%",
margin:"auto",
backgroundColor: isDark ? "darkorchid" : "rgba(76, 175, 80, 0.1)"
}}
   whileHover={{rotateY:[0,15,-15,0] ,rotateX:15}}
...
>
            <motion.li variants={item}>Signup</motion.li>
            <motion.li variants={item}>Login</motion.li>
            <motion.li variants={item}>Search Recipe</motion.li>
            <motion.li variants={item}>Recipe of the day</motion.li>
